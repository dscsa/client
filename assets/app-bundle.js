  ...
  var drugs = exports.drugs = (_dec = (0, _aureliaFramework.inject)(_pouch.Db, _aureliaRouter.Router), _dec(_class = function () {
    ...
    drugs.prototype.activate = function activate(params) {
      ...
      return this.db.user.session.get().then(function (session) {
        ...
        _this.drawer = {
          ordered: Object.keys(_this.account.ordered)
        };

        if (!params.id) return _this.selectDrawer(_this.drawer.ordered[0]);
    ...
    drugs.prototype.scrollGroups = function scrollGroups($event) {
      ...
      Promise.resolve(this._search).then(function (_) {
        var index = _this2.groups.map(function (group) {
          return group.name;
        }).indexOf(_this2.group.name);
        _this2.scrollSelect($event, index, _this2.groups, function (group) {
          return _this2.selectGroup(group, true);
        });

        if ($event.which == 13) {
          _this2.selectGroup(null, true);
    ...
    drugs.prototype.selectGroup = function selectGroup(group, autoselectDrug) {
      ...
      if (!group.drugs) group = this.search().then(function (_) {
        return _this3.groups.filter(function (group) {
          return _this3.term == group.name;
        })[0];
      });

      this.db.transaction.get({ generic: this.term, 'shipment._id': this.account._id }).then(function (transactions) {
    ...
    drugs.prototype.selectDrug = function selectDrug(drug, autoselectGroup) {
      ...
      if (autoselectGroup) this.selectGroup({ name: this.drug.generic });
    };
    ...
    drugs.prototype.search = function search() {
      ...
      var groups = {};
      return this._search = drugs.then(function (drugs) {
      ...
      this.db.drug.get().then(function (drugs) {
        _this6.csv.unparse('Drugs.csv', drugs.map(function (drug) {
          return {
            ...
            ordered: _this6.account.ordered[generic] || { minQty: null, minDays: null, message: null }
          };
        }));
      });
    };
    ...
    drugs.prototype.addDrug = function addDrug() {
      ...
      this.db.drug.post(this.drug).then(function (res) {
        ...
        return _this8.snackbar.show('Drug not added: ' + err.reason);
      });
    };
    ...
    drugs.prototype.saveDrug = function saveDrug() {
      ...
      this.db.drug.put(this.drug).then(function (res) {
        ...
        return _this9.snackbar.show('Drug not saved: ' + err.reason);
      });
    };
...
define('views/inventory',['exports', 'aurelia-framework', '../libs/pouch', 'aurelia-router'], function (exports, _aureliaFramework, _pouch, _aureliaRouter) {
  ...
  exports.filterValueConverter = exports.toArrayValueConverter = exports.jsonValueConverter = exports.dateValueConverter = exports.numberValueConverter = exports.inventory = undefined;
  ...
  var inventory = exports.inventory = (_dec = (0, _aureliaFramework.inject)(_pouch.Db, _aureliaRouter.Router), _dec(_class = function () {
    ...
    inventory.prototype.saveTransaction = function saveTransaction($index) {
      var _this4 = this;
      ...
      Promise.resolve(this._saveTransaction).then(function (_) {
        ...
        console.log('saving', _this4.group.transactions[$index]);
        _this4._saveTransaction = _this4.db.transaction.put(_this4.group.transactions[$index]);
      }).catch(function (err) {
        return _this4.snackbar.show('Error saving transaction: ' + (err.reason || err.message));
      });
    };
  ...
  var dateValueConverter = exports.dateValueConverter = function () {
    ...
    dateValueConverter.prototype.fromView = function fromView(date) {
      ...
      var _parseUserDate = parseUserDate(date.replace(/\+|\-|\=/g, ''));
  ...
  var join = exports.join = (_dec = (0, _aureliaFramework.inject)(_pouch.Db, _aureliaRouter.Router, _aureliaHttpClient.HttpClient), _dec(_class = function () {
    ...
    join.prototype.join = function join() {
      ...
      this.db.account.post(this.account).then(function (account) {
        ...
        _this.snackbar.show('Join failed: ' + err.reason);
      });
    };
...
define('views/records',['exports', 'aurelia-framework', 'aurelia-router', '../libs/pouch', 'aurelia-http-client'], function (exports, _aureliaFramework, _aureliaRouter, _pouch, _aureliaHttpClient) {
  ...
  exports.filterValueConverter = exports.records = undefined;
  ...
  var records = exports.records = (_dec = (0, _aureliaFramework.inject)(_pouch.Db, _aureliaRouter.Router, _aureliaHttpClient.HttpClient), _dec(_class = function () {
    ...
    records.prototype.activate = function activate(params) {
      ...
      this.db.user.session.get().then(function (session) {
        ...
        _this.selectDay(params._id);
      });
    };

    records.prototype.selectDay = function selectDay(day) {
      var _this2 = this;
      ...
      var query = { 'shipment._id': { $ne: this.account._id }, createdAt: { $gte: this.day, $lte: to.toJSON().slice(0, 10) } };
...
define('views/shipments',['exports', 'aurelia-framework', 'aurelia-router', '../libs/pouch', 'aurelia-http-client', '../libs/csv'], function (exports, _aureliaFramework, _aureliaRouter, _pouch, _aureliaHttpClient, _csv) {
  ...
  exports.dateValueConverter = exports.numberValueConverter = exports.boldValueConverter = exports.valueValueConverter = exports.filterValueConverter = exports.jsonValueConverter = exports.shipments = undefined;
  ...
  var shipments = exports.shipments = (_dec = (0, _aureliaFramework.inject)(_pouch.Db, _aureliaRouter.Router, _aureliaHttpClient.HttpClient), _dec(_class = function () {
    ...
    shipments.prototype.selectShipment = function selectShipment(shipment, toggleDrawer) {
      if (toggleDrawer) document.querySelector('.mdl-layout__header').firstChild.click();
    ...
    shipments.prototype.qtyShortcuts = function qtyShortcuts($event, $index) {
      ...
      if ($event.which == 13) {
        var boxInput = document.querySelector('#box_' + $index + ' input');
    ...
    shipments.prototype.saveLastBox = function saveLastBox($event, $index) {
      if ($event.target.validity.valid) this.lastBox = $event.target.value;
    ...
    shipments.prototype.autoCheck = function autoCheck($index, userInput) {
      ...
      if (userInput) transaction.location = ordered.defaultLocation || this.lastBox;
...
define('elems/md-select copy',['exports', 'aurelia-framework'], function (exports, _aureliaFramework) {
  'use strict';
...
define('text!elems/md-select copy.html', ['module'], function(module) { module.exports = "<!-- vertical-align top is necessary for firefox -->\n<template style=\"display:inline-block; box-sizing:border-box; vertical-align:top; margin-bottom:8px\">\n  <style>\n  @-moz-document url-prefix() {\n    select {\n       text-indent:-2px;\n    }\n  }\n  </style>\n  <div ref=\"div\" class=\"mdl-textfield mdl-js-textfield mdl-textfield--floating-label\" style=\"width:100%; ${ label.textContent.trim() || 'padding-top:0px'}; margin-bottom:-12px; font-size:inherit;\">\n    <!-- Chrome's input[type=date] has a minimum height of 24px because of its internal buttons, to align heights we need to make all have min-height.  Not sure why extra pixels are necessary in chrome and firefox -->\n    <select\n      class=\"mdl-textfield__input\"\n      value.bind=\"value\"\n      disabled.bind=\"disabled || disabled === ''\"\n      required.bind=\"required || required === ''\"\n      style=\"padding:0; min-height:26px; line-height:26px; border-radius:0; font-size:inherit; font-weight:inherit; text-transform:inherit; -webkit-appearance:none; -moz-appearance:none;\">\n      <option if.bind=\"default\" model.bind=\"default\">\n        ${ property ? default[property] : default }\n      </option>\n      <option model.bind=\"option\" repeat.for=\"option of options\">\n        ${ property ? option[property] : option }\n      </option>\n    </select>\n    <label ref=\"label\" class=\"mdl-textfield__label\" style=\"text-align:inherit;\">\n      <slot></slot>\n    </label>\n  </div>\n</template>\n"; });
