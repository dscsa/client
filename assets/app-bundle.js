...
define('views/records',['exports', 'aurelia-framework', 'aurelia-router', '../libs/pouch', 'aurelia-http-client'], function (exports, _aureliaFramework, _aureliaRouter, _pouch, _aureliaHttpClient) {
  ...
  var records = exports.records = (_dec = (0, _aureliaFramework.inject)(_pouch.Db, _aureliaRouter.Router, _aureliaHttpClient.HttpClient), _dec(_class = function () {
    ...
    records.prototype.activate = function activate(params) {
      ...
      this.db.user.session.get().then(function (session) {
        ...
        _this.selectWeek(params._id);
      });
    };

    records.prototype.selectWeek = function selectWeek(week) {
      var _this2 = this;

      this.week = week || this.weeks[0];
      this.router.navigate('records/' + this.week, { trigger: false });

      var to = new Date(this.week);
      to.setHours(24 * 7);

      var query = { 'shipment._id': { $ne: this.account._id }, createdAt: { $gte: this.week, $lte: to.toJSON().slice(0, 10) } };
  ...
  var filterValueConverter = exports.filterValueConverter = function () {
    ...
    filterValueConverter.prototype.toView = function toView() {
      var weeks = arguments.length <= 0 || arguments[0] === undefined ? [] : arguments[0];
      var filter = arguments.length <= 1 || arguments[1] === undefined ? '' : arguments[1];

      return weeks.filter(function (week) {
        return ~week.indexOf(filter);
      });
    };
