  ...
  var drugs = exports.drugs = (_dec = (0, _aureliaFramework.inject)(_pouch.Db, _aureliaRouter.Router), _dec(_class = function () {
    ...
    drugs.prototype.scrollGroups = function scrollGroups($event) {
      ...
      Promise.resolve(this._search).then(function (_) {
        var index = _this2.groups.indexOf(_this2.group);
    ...
    drugs.prototype.selectGroup = function selectGroup(group, autoselectDrug) {
      ...
      this.db.transaction.get({ generic: group.name, 'shipment._id': this.account._id }).then(function (transactions) {
...
define('views/inventory',['exports', 'aurelia-framework', '../libs/pouch', 'aurelia-router', '../resources/helpers'], function (exports, _aureliaFramework, _pouch, _aureliaRouter, _helpers) {
  ...
  var inventory = exports.inventory = (_dec = (0, _aureliaFramework.inject)(_pouch.Db, _aureliaRouter.Router), _dec(_class = function () {
    ...
    inventory.prototype.selectGroup = function selectGroup() {
      ...
      this.db.transaction.get({ generic: group.name, 'shipment._id': this.account }).then(function (transactions) {
    ...
    inventory.prototype.search = function search() {
      ...
      this.drugSearch().then(function (drugs) {
        ...
        for (var _iterator2 = drugs, _isArray2 = Array.isArray(_iterator2), _i2 = 0, _iterator2 = _isArray2 ? _iterator2 : _iterator2[Symbol.iterator]();;) {
          ...
          if (!drug.generic) console.log('drug.generic', drug.generic, drug);
    ...
    inventory.prototype.removeInventory = function removeInventory() {
      ...
      var _loop = function _loop() {
        ...
        if (transaction.isChecked) {
          remove.push(_this4.db.transaction.delete(transaction).then(function (_) {
            return _this4.group.transactions.splice(_this4.group.transactions.indexOf(transaction), 1);
          }));
        }
      };
      ...
      Promise.all(remove).then(function (_) {
        return _this4.snackbar.show(remove.length + ' transactions removed from inventory');
      });
    };
