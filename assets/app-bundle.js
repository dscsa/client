  ...
  var drugs = exports.drugs = (_dec = (0, _aureliaFramework.inject)(_pouch.Db, _aureliaRouter.Router), _dec(_class = function () {
    ...
    drugs.prototype.order = function order() {
      ...
      if (this.account.ordered[this.group.name]) {
        this.drawer.ordered = this.drawer.ordered.filter(function (generic) {
          return generic != _this7.group.name;
        });
    ...
    drugs.prototype.exportCSV = function exportCSV() {
      ...
      this.db.drug.get().then(function (drugs) {
        _this8.csv.unparse('Drugs.csv', drugs.map(function (drug) {
          ...
          return {
            ...
            ordered: _this8.account.ordered[generic] || { minQty: null, minDays: null, message: null }
          };
        }));
      });
    };
    ...
    drugs.prototype.importCSV = function importCSV() {
      ...
      this.csv.parse(this.$file.files[0]).then(function (parsed) {
        ...
        _this9.snackbar.show('Parsed ' + rows.length + ' rows. Uploading to server');
        return _this9.db.drug.post(rows);
      }).then(function (_) {
        return _this9.snackbar.show('Drugs import completed in ' + (Date.now() - start) + 'ms');
      }).catch(function (err) {
        return _this9.snackbar.show('Drugs not imported: ' + err);
      });
    };
    ...
    drugs.prototype.addDrug = function addDrug() {
      ...
      this.db.drug.post(this.drug).then(function (res) {
        setTimeout(function (_) {
          return _this10.selectDrug(_this10.drug, true);
        }, 200);
      }).catch(function (err) {
        return _this10.snackbar.show('Drug not added: ' + err.name);
      });
    };
    ...
    drugs.prototype.saveDrug = function saveDrug() {
      ...
      this.db.drug.put(this.drug).catch(function (err) {
        return _this11.snackbar.show('Drug not saved: ' + err.name);
      });
    };
...
define('views/records',['exports', 'aurelia-framework', 'aurelia-router', '../libs/pouch', 'aurelia-http-client'], function (exports, _aureliaFramework, _aureliaRouter, _pouch, _aureliaHttpClient) {
  ...
  exports.filterValueConverter = exports.shipments = undefined;
