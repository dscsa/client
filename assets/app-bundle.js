  ...
  var inventory = exports.inventory = (_dec = (0, _aureliaFramework.inject)(_pouch.Db, _aureliaRouter.Router), _dec(_class = function () {
    ...
    inventory.prototype.selectGroup = function selectGroup(group) {
      ...
      this.db.transaction.get(Object.assign({ inventory: true }, group), { limit: this.limit }).then(function (transactions) {
        ...
        _this2.group = group;
        _this2.transactions = transactions.sort(function (a, b) {
        ...
        _this2.resetFilter();
        for (var _iterator = _this2.transactions, _isArray = Array.isArray(_iterator), _i = 0, _iterator = _isArray ? _iterator : _iterator[Symbol.iterator]();;) {
          var _ref;
    ...
    inventory.prototype.removeInventory = function removeInventory(nextDescription) {
      var _this4 = this;
...
define('elems/md-table copy',["exports", "aurelia-framework"], function (exports, _aureliaFramework) {
  "use strict";
