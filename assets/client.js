  ...
  function getHistory(id) {
    ...
    return this.db.transaction.history.get(id).then(function (_history) {
      ...
      return JSON.stringify(_history, function (k, v) {
        ...
        var qty = '<a href=\'//' + window.location.hostname + ':5984/_utils/#database/transaction/' + id + '\' target=\'_blank\'>' + pad('Quantity ' + (v.qty.to || v.qty.from), 20) + '</a>';
