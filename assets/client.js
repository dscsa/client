  ...
  var inventory = exports.inventory = (_dec = (0, _aureliaFramework.inject)(_pouch.Pouch, _aureliaRouter.Router), _dec(_class = function () {
    ...
    inventory.prototype.repackInventory = function repackInventory() {
      ...
      Promise.all(all).then(function (all) {
        ...
        var label = ['<p style="page-break-after:always;">', '<strong>' + (_this8.transactions[0].drug.generic + ' ' + _this8.transactions[0].drug.form) + '</strong>', 'Ndc ' + _this8.transactions[0].drug._id, 'Exp ' + _this8.repack.exp.slice(0, 10), 'Bin ' + _this8.repack.location, 'Qty ' + _this8.repack.vialQty, 'Pharmacist ________________', '</p>'];
    ...
    inventory.prototype.openMenu = function openMenu($event) {
      ...
      this.repack.totalQty = 0, this.repack.exp = '2099-01-01T00:00:00';
