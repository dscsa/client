  ...
  var MdCheckboxCustomElement = exports.MdCheckboxCustomElement = (_dec = (0, _aureliaFramework.bindable)({ name: 'checked', defaultBindingMode: _aureliaFramework.bindingMode.twoWay }), _dec2 = (0, _aureliaFramework.bindable)('disabled'), _dec3 = (0, _aureliaFramework.bindable)('required'), _dec4 = (0, _aureliaFramework.inject)(Element, _aureliaFramework.TaskQueue), _dec(_class = _dec2(_class = _dec3(_class = _dec4(_class = function () {
    ...
    MdCheckboxCustomElement.prototype.checkedChanged = function checkedChanged() {
      ...
      this.taskQueue.queueTask(function (_) {
        return _this.label && _this.label.MaterialCheckbox && _this.label.MaterialCheckbox.checkToggleState();
      });
    };
    ...
    MdCheckboxCustomElement.prototype.disabledChanged = function disabledChanged() {
      ...
      this.taskQueue.queueTask(function (_) {
        return _this2.label && _this2.label.MaterialCheckbox && _this2.label.MaterialCheckbox.checkDisabled();
      });
    };
...
define('client/src/elems/md-menu',['exports', 'aurelia-framework'], function (exports, _aureliaFramework) {
  ...
  var MdMenuCustomElement = exports.MdMenuCustomElement = (_dec = (0, _aureliaFramework.inject)(_aureliaFramework.ObserverLocator, Element), _dec(_class = function () {
    ...
    MdMenuCustomElement.prototype.openCloseButtonClick = function openCloseButtonClick() {
      var isOpenClick = !this.element.querySelector('.mdl-menu__container').classList.contains('is-visible');

      var eventName = isOpenClick ? 'open' : 'close';
...
define('client/src/views/index',['exports', '../../../../client/src/resources/v3/app.js'], function (exports) {
  'use strict';
  ...
  function configure(aurelia) {
    ...
    aurelia.use.standardConfiguration().plugin('aurelia-animator-css').plugin('aurelia-http-client').globalResources(['client/src/resources/value-converters']);
...
define('client/src/views/inventory',['exports', 'aurelia-framework', '../libs/pouch', 'aurelia-router', '../libs/csv', '../resources/helpers', 'client/src/resources/v3/InventoryItemsList'], function (exports, _aureliaFramework, _pouch, _aureliaRouter, _csv, _helpers, _InventoryItemsList) {
    'use strict';
    ...
    var inventory = exports.inventory = (_dec = (0, _aureliaFramework.inject)(_pouch.Pouch, _aureliaRouter.Router), _dec(_class = function () {
        function inventory(db, router) {
            ...
            this.inventoryItemsList = new _InventoryItemsList.InventoryItemsList();
        ...
        inventory.prototype.toggleDrawerCheck = function toggleDrawerCheck(pendId, label) {
            ...
            for (var _i = 0; _i < temp_transactions.length; _i++) {
                temp_transactions[_i].next[0].pended.priority = this.shoppingSyncPended[pendId][label].drawerCheck ? false : null;
            }
        ...
        inventory.prototype.togglePriority = function togglePriority(pendId) {
            ...
            for (var _i2 = 0; _i2 < transactions_to_update.length; _i2++) {
                if (typeof transactions_to_update[_i2].next[0].pended.priority != 'undefined' && transactions_to_update[_i2].next[0].pended.priority == null) continue;
                transactions_to_update[_i2].next[0].pended.priority = transactions_to_update[_i2].next[0].pended.priority ? !transactions_to_update[_i2].next[0].pended.priority : true;
            }
        ...
        inventory.prototype.toggleCheck = function toggleCheck(transaction) {
            ...
            this.inventoryItemsList.setSelectedStatusById(transaction.id, !transaction.isChecked);
        };
        ...
        inventory.prototype.setVisibleChecks = function setVisibleChecks(isChecked) {
            ...
            for (var _iterator = filtered, _isArray = Array.isArray(_iterator), _i3 = 0, _iterator = _isArray ? _iterator : _iterator[Symbol.iterator]();;) {
                var _ref;
                ...
                var _transaction = _ref;

                this.updateFilterCountsAndSetCheck(_transaction, isChecked);
            }this.filter.checked.visible = isChecked;
        };

        inventory.prototype.updateFilterCountsAndSetCheck = function updateFilterCountsAndSetCheck(transaction, isChecked) {
            ...
            if (!isChecked && transaction.isChecked) {
                ...
                delete this.selectedTransactions[transaction.id];
            }
        ...
        inventory.prototype.selectInventory = function selectInventory(type, key, limit) {
            ...
            if (type == 'bin' && key.length == 3) {
                ...
                v3.getRequest('inventory/available/' + key).onSuccess(function (response) {
                    console.log(response);
                    _this7.inventoryItemsList.setItems(response);
                });
            ...
            var setTransactions = function setTransactions(res) {
                ...
                var docs = [];
                for (var _iterator2 = res.rows, _isArray2 = Array.isArray(_iterator2), _i4 = 0, _iterator2 = _isArray2 ? _iterator2 : _iterator2[Symbol.iterator]();;) {
                    var _ref2;
                    ...
                    if (!row.doc.next.length || type == 'bin' && row.doc.next[0].pended && !row.doc.next[0].picked) {
                        docs.push(row.doc);
        ...
        inventory.prototype.updateSelected = function updateSelected(updateFn) {
            ...
            for (var _i5 = length - 1; _i5 >= 0; _i5--) {
                var _transaction2 = this.transactions[_i5];

                if (!_transaction2.isChecked) continue;

                checkedTransactions.unshift(_transaction2);

                this.updateFilterCountsAndSetCheck(_transaction2, false);
                this.transactions.splice(_i5, 1);
                this.unsetPended(_transaction2);

                updateFn(_transaction2);
            }
        ...
        inventory.prototype.unpendInventory = function unpendInventory() {
            ...
            this.updateSelected(function (transaction) {
                var next = _this9.clearNextProperty(transaction.next, 'pended');
        ...
        inventory.prototype.getSelectedTransactionIds = function getSelectedTransactionIds() {
            var selectedTransactions = [];

            for (var _iterator3 = Object.values(this.selectedTransactions), _isArray3 = Array.isArray(_iterator3), _i6 = 0, _iterator3 = _isArray3 ? _iterator3 : _iterator3[Symbol.iterator]();;) {
                var _ref3;
                ...
                var _transaction3 = _ref3;

                selectedTransactions.push(_transaction3.id);
            }
        ...
        inventory.prototype.pendInventory = function pendInventory() {
            ...
            console.log(this.pendToQty);
            var toPend = [];
            var repackQty = this.pendToQty;
            var pended_obj = { _id: new Date().toJSON(), user: this.user, repackQty: repackQty, group: this.pendToId };
            var ids = this.getSelectedTransactionIds();

            var request = v3.postRequest('inventory/pend', {
                inventory_ids: ids,
                group_name: this.pendToId,
                priority: false
            });

            request.onSuccess(function () {
                ids.forEach(function (id) {
                    var inventoryItem = _this10.inventoryItemsList.removeItemById(id);
                    _this10.updateFilterCountsAndSetCheck(inventoryItem, false);
                });

                return;
                _this10.updateFilterCountsAndSetCheck(transaction, false);

                _this10.transactions.splice(i, 1);
                _this10.unsetPended(transaction);

                _this10.setPended(toPend);

                var label = pendId;
                console.log(_this10.repacks);
                if (_this10.repacks.drug.generic) label += ': ' + _this10.pended[pendId][_this10.repacks.drug.generic].label;

                _this10.selectTerm('pended', label);
            });
            return;
            var transactions_in_group = this.extractTransactions(this.pendToId, '');
            console.log("other transactions already in group:", transactions_in_group);

            var should_lock = false;

            var pendId = this.pendToId;
        ...
        inventory.prototype.setPended = function setPended(transactions) {
            return;
            for (var _iterator4 = transactions, _isArray4 = Array.isArray(_iterator4), _i7 = 0, _iterator4 = _isArray4 ? _iterator4 : _iterator4[Symbol.iterator]();;) {
                var _ref4;
                ...
                var _transaction4 = _ref4;

                var _pendId = this.getPendId(_transaction4);
                var pendQty = this.getPendQty(_transaction4);

                var generic = _transaction4.drug.generic;
                var label = generic + (pendQty ? ' - ' + pendQty : '');

                this.pended[_pendId] = this.pended[_pendId] || {};
                this.pended[_pendId][generic] = this.pended[_pendId][generic] || { label: label, transactions: [] };
                this.pended[_pendId][generic].transactions.push(_transaction4);

                this.shoppingSyncPended[_pendId] = this.shoppingSyncPended[_pendId] || {};

                this.shoppingSyncPended[_pendId].locked = this.shoppingSyncPended[_pendId].locked == false ? false : _transaction4.next[0].picked ? true : false;

                this.shoppingSyncPended[_pendId].priority = _transaction4.next[0].pended.priority ? _transaction4.next[0].pended.priority : false;
                this.shoppingSyncPended[_pendId][label] = this.shoppingSyncPended[_pendId][label] || {};
                this.shoppingSyncPended[_pendId][label].drawerCheck = typeof _transaction4.next[0].pended.priority == 'undefined' ? true : _transaction4.next[0].pended.priority != null;

                this.shoppingSyncPended[_pendId][label].locked = this.shoppingSyncPended[_pendId].locked;
                var basketFound = _transaction4.next[0].picked && _transaction4.next[0].picked.basket;
                this.shoppingSyncPended[_pendId][label].basketInfo = this.shoppingSyncPended[_pendId][label].basketInfo || {};
                this.shoppingSyncPended[_pendId][label].basketInfo.found = this.shoppingSyncPended[_pendId][label].basketInfo.found ? this.shoppingSyncPended[_pendId][label].basketInfo.found : basketFound;
                this.shoppingSyncPended[_pendId][label].basketInfo.notFound = this.shoppingSyncPended[_pendId][label].basketInfo.notFound ? this.shoppingSyncPended[_pendId][label].basketInfo.notFound : !basketFound;
                this.shoppingSyncPended[_pendId][label].basketInfo.basket = this.shoppingSyncPended[_pendId][label].basketInfo.basket ? this.shoppingSyncPended[_pendId][label].basketInfo.basket : basketFound ? _transaction4.next[0].picked.basket : null;
                if (basketFound) {
                    var basket = _transaction4.next[0].picked.basket;
                    if (!this.shoppingSyncPended[_pendId][label].basketInfo.allBaskets) this.shoppingSyncPended[_pendId][label].basketInfo.allBaskets = [];
                    if (!~this.shoppingSyncPended[_pendId][label].basketInfo.allBaskets.indexOf(basket) && _transaction4.next[0].picked.matchType !== 'missing') this.shoppingSyncPended[_pendId][label].basketInfo.allBaskets.unshift(basket);
                }
            }
        };
        ...
        inventory.prototype.dispenseInventory = function dispenseInventory() {
            v3.postRequest('inventory/dispense', { itemIds: this.inventoryItemsList.getSelectedItemIds() });
        ...
        inventory.prototype.disposeInventory = function disposeInventory() {
            v3.postRequest('inventory/dispose', { itemIds: this.inventoryItemsList.getSelectedItemIds() });
            return;
            console.log(this.inventoryItemsList);
        ...
        inventory.prototype.repackInventory = function repackInventory() {
            ...
            console.log(this.repacks);
            v3.postRequest('inventory/repack', { items: this.repacks });
            return;
            ...
            for (var _iterator5 = this.repacks, _isArray5 = Array.isArray(_iterator5), _i8 = 0, _iterator5 = _isArray5 ? _iterator5 : _iterator5[Symbol.iterator]();;) {
                var _ref5;
            ...
            this.db.transaction.bulkDocs(newTransactions).then(function (rows) {
                var errors = [];
                for (var _i9 = rows.length - 1; _i9 >= 0; _i9--) {
                    if (!rows[_i9].error) continue;
                    if (!errors.includes(rows[_i9].message)) errors.push(rows[_i9].message);
                    _this12.transactions.splice(_i9, 1);
                }
        ...
        inventory.prototype.getPendId = function getPendId(transaction) {
            if (transaction) {
                ...
                var _pendId2 = transaction.next[0] ? transaction.next[0].pended.group : null;
                var created = transaction.next[0] ? transaction.next[0].pended._id : transaction._id;

                return _pendId2 ? _pendId2 : created.slice(5, 16).replace('T', ' ');
            }
        ...
        inventory.prototype.getPendQty = function getPendQty(transaction) {
            if (transaction) {
                var _pendId3 = transaction.next[0] ? transaction.next[0].pended.repackQty : null;
                return _pendId3 ? _pendId3 : undefined;
            }
        ...
        inventory.prototype.printLabels = function printLabels(transactions) {
            ...
            transactions = transactions || this.inventoryItemsList.getSelectedItems();
            ...
            for (var _iterator6 = Object.values(transactions), _isArray6 = Array.isArray(_iterator6), _i10 = 0, _iterator6 = _isArray6 ? _iterator6 : _iterator6[Symbol.iterator]();;) {
                var _ref6;
                ...
                var label = ['<p style="page-break-after:always; white-space:nowrap">', '<strong>' + item.productName + '</strong>', item.createdAt.slice(2, -1), 'Ndc ' + item.drugId, 'Exp ' + item.expirationDate.slice(0, 7), 'Bin ' + item.bin, 'Qty ' + item.quantity, 'User ' + userInfo.name.first + ' ' + userInfo.name.last + ', ' + userInfo.phone, pendId + ', #' + numDrugs, 'Pharmacist ________________', '</p>'].join('<br>');
        ...
        inventory.prototype.saveAndReconcileTransaction = function saveAndReconcileTransaction(transaction) {
            ...
            this.db.transaction.get(transaction._id).then(function (repack) {
                ...
                return _this13.db.transaction.query('next.transaction._id', {
                    key: [_this13.account._id, transaction._id],
                    include_docs: true
                }).then(function (res) {
        ...
        inventory.prototype.exportCSV = function exportCSV() {
            ...
            var request = v3.getRequest('inventory/available');

            request.onSuccess(function (data) {
                _this14.csv.fromJSON(name, data.map(function (item) {
                    console.log(item);
                    return {
                        'drug.generic': item.product_name,
                        'drug.gsns': 'todo',
                        'drug.brand': 'todo',
                        'drug._id': item.created_at,
                        'exp.to': item.expiration_date,
                        'qty.to': item.quantity,
                        'val.to': 'todo && wtf is this anyway?',
                        'bin': item.bin,
                        '_id': item.id
                    };
                }));
        ...
        inventory.prototype.setRepacks = function setRepacks() {
            ...
            for (var _iterator7 = this.transactions, _isArray7 = Array.isArray(_iterator7), _i11 = 0, _iterator7 = _isArray7 ? _iterator7 : _iterator7[Symbol.iterator]();;) {
                var _ref7;
                ...
                var _transaction5 = _ref7;


                if (!_transaction5.isChecked) continue;

                if (repacks.drug == null) {
                    repacks.drug = JSON.parse(JSON.stringify(_transaction5.drug));
                    repacks.drug.price = { goodrx: 0, nadac: 0, retail: 0, updatedAt: new Date().toJSON() };
                    console.log('this.repacks.drug is null', repacks.drug);
                } else if (repacks.drug._id != _transaction5.drug._id) {
                    console.error('this.repacks.drug mismatch', repacks.drug, _transaction5.drug);
                    repacks.drug = false;
                    this.snackbar.show('Warning: Mismatched NDCs');
                    break;
                }

                repacks.drug.price.goodrx += _transaction5.drug.price.goodrx * _transaction5.qty.to / this.filter.checked.qty;
                repacks.drug.price.nadac += _transaction5.drug.price.nadac * _transaction5.qty.to / this.filter.checked.qty;
                repacks.drug.price.retail += _transaction5.drug.price.retail * _transaction5.qty.to / this.filter.checked.qty;
                console.log('setRepacks weighted price', repacks.drug.price.goodrx, _transaction5.drug.price.goodrx, _transaction5.qty.to, this.filter.checked.qty);

                repacks.exp = repacks.exp && repacks.exp < _transaction5.exp.to ? repacks.exp : _transaction5.exp.to;
            }
    ...
    var inventoryFilterValueConverter = exports.inventoryFilterValueConverter = function () {
        ...
        inventoryFilterValueConverter.prototype.toView = function toView() {
            ...
            transactions = transactions.filter(function (transaction, i) {
                ...
                if (!expFilter[exp]) {
                    expFilter[exp] = {
                        isChecked: filter.exp && filter.exp[exp] ? filter.exp[exp].isChecked : defaultCheck || pended || false,
                        count: 0,
                        qty: 0
                    };
                }
                ...
                if (!expFilter[isExp]) {
                    expFilter[isExp] = {
                        isChecked: filter.exp && filter.exp[isExp] ? filter.exp[isExp].isChecked : isBin && isExp == 'Unexpired' && term[3] == '*' ? false : true,
                        count: 0,
                        qty: 0
                    };
                }

                if (!ndcFilter[ndc]) ndcFilter[ndc] = {
                    isChecked: filter.ndc && filter.ndc[ndc] ? filter.ndc[ndc].isChecked : defaultCheck || pended || !i,
                    count: 0,
                    qty: 0
                };

                if (!formFilter[form]) formFilter[form] = {
                    isChecked: filter.form && filter.form[form] ? filter.form[form].isChecked : defaultCheck || pended || !i,
                    count: 0,
                    qty: 0
                };

                if (!repackFilter[repack]) repackFilter[repack] = {
                    isChecked: filter.repack && filter.repack[repack] ? filter.repack[repack].isChecked : defaultCheck || pended || !repackFilter['Repacked'],
                    count: 0,
                    qty: 0
                };
                ...
                if (!expFilter[isExp].isChecked) {
                    ...
                    return inventory.prototype.updateFilterCountsAndSetCheck.call({ filter: filter }, transaction, false);
                }
    ...
    var pendedFilterValueConverter = exports.pendedFilterValueConverter = function () {
        ...
        pendedFilterValueConverter.prototype.toView = function toView() {
            ...
            var matches = [];
            for (var _pendId4 in pended) {
                if (~_pendId4.toLowerCase().indexOf(term)) {
                    matches.unshift({ key: _pendId4, val: pended[_pendId4] });
                    continue;
                }

                var basketMatches = {};

                for (var generic in pended[_pendId4]) {
                    var transactions = pended[_pendId4][generic].transactions;
                    for (var i = 0; i < transactions.length; i++) {
                        if (transactions[i].next[0].picked && transactions[i].next[0].picked.basket && ~transactions[i].next[0].picked.basket.toLowerCase().indexOf(term)) {
                            basketMatches[generic] = pended[_pendId4][generic];
                        }
                    }
                }

                if (Object.keys(basketMatches).length) matches.unshift({ key: _pendId4, val: basketMatches });

                var genericMatches = {};

                for (var _generic in pended[_pendId4]) {
                    if (~_generic.toLowerCase().indexOf(term)) genericMatches[_generic] = pended[_pendId4][_generic];
                }if (Object.keys(genericMatches).length) matches.unshift({ key: _pendId4, val: genericMatches });
            }
...
define('client/src/views/picking',['exports', 'aurelia-framework', '../libs/pouch', 'aurelia-router', '../resources/helpers', 'client/src/resources/v3/PendGroup'], function (exports, _aureliaFramework, _pouch, _aureliaRouter, _helpers, _PendGroup) {
  'use strict';
  ...
  var shopping = exports.shopping = (_dec = (0, _aureliaFramework.inject)(_pouch.Pouch, _aureliaRouter.Router), _dec(_class = function () {
    ...
    shopping.prototype.activate = function activate(params) {
      ...
      return this.db.user.session.get().then(function (session) {
        ...
        if (_this.isValidGroupName()) {
          _this.loadGroupAndStartShopping(params.groupName);
        } else {
    ...
    shopping.prototype.loadGroupAndStartShopping = function loadGroupAndStartShopping(groupName) {
      var _this2 = this;

      this.currentPendGroup = new _PendGroup.PendGroup();
      this.currentPendGroup.loadFromName(groupName, function () {

        if (!_this2.currentPendGroup.isShoppable()) {
          alert('There are no items in this group');
          _this2.currentPendGroup = null;
          _this2.loadGroupSelectionPage();
          return;
        }

        _this2.currentPendGroup.onShopListLoad(function () {
          _this2.shopList = _this2.currentPendGroup.shopList;
          _this2.groupData = _this2.currentPendGroup;
          _this2.groupLoaded = true;
          _this2.shoppingIndex = _this2.shoppingIndex > 0 ? _this2.shoppingIndex : 0;
          _this2.initShoppingIndexParameters();

          _this2.pendedFilter = '';
          _this2.filter = {};
        });

        _this2.currentPendGroup.loadShopList();
      });
    };
    ...
    shopping.prototype.updatePickedCount = function updatePickedCount() {
      ...
      this.db.transaction.query('picked-by-user-from-shipment', { startkey: [this.account._id, this.user._id, year, month, day], endkey: [this.account._id, this.user._id, year, month, day, {}] }).then(function (res) {
        console.log(res);
        _this3.pickedCount = res.rows[0] ? res.rows[0].value[0].count : 0;
      });
    };
    ...
    shopping.prototype.refreshPendedGroups = function refreshPendedGroups() {
      ...
      v3.getCurrentUser().then(function () {
        var request = v3.getRequest('picking/current_unpicked');

        request.onSuccess(function (response) {

          var groups = [];

          for (var _iterator3 = response, _isArray3 = Array.isArray(_iterator3), _i3 = 0, _iterator3 = _isArray3 ? _iterator3 : _iterator3[Symbol.iterator]();;) {
            var _ref4;
            ...
            var group = new _PendGroup.PendGroup(groupData);
            groups.push(group);
          }
    ...
    shopping.prototype.selectGroup = function selectGroup(groupName, isLocked, isLockedByCurrentUser) {
      ...
      this.loadGroupAndStartShopping(groupName);
    };

    shopping.prototype.legacySelectGroup = function legacySelectGroup() {
      var _this6 = this;
      ...
      this.db.account.picking.post({ groupName: groupName, action: 'load' }).then(function (res) {
        ...
        _this6.setPickingStepUrl(1);

        _this6.shopList = res.shopList;
        _this6.groupData = res.groupData;
        _this6.pendedFilter = '';
        _this6.filter = {};
        _this6.initializeShopper();

        if (res.groupData && res.groupData.baskets && res.groupData.baskets.length) {
          _this6.basketSaved = true;
          _this6.addBasketToShoppingList(res.groupData.baskets.slice(-1));
        }
      }).catch(function (err) {
    ...
    shopping.prototype.updateRevs = function updateRevs(res) {
      ...
      this.shopList.forEach(function (shopListItem, index) {
        if (results[shopListItem.raw._id]) {
          _this7.shopList[index].raw._rev = results[shopListItem.raw._id].rev;
    ...
    shopping.prototype.saveShoppingResults = function saveShoppingResults(arr_enriched_transactions, key) {
      ...
      return this.db.transaction.bulkDocs(transactions_to_save).then(function (res) {
        ...
        if (err.status == 0) {
          ...
          return _this8.delay(3000).then(function (_) {

            console.log("waiting finished, sending again");

            return _this8.db.transaction.bulkDocs(transactions_to_save).then(function (res) {
          ...
          _this8.snackbar.error('Error loading/saving. Contact Adam', err);
    ...
    shopping.prototype.saveBasketNumber = function saveBasketNumber() {
      ...
      var basket = {
        letter: this.currentBasket.letter,
        number: this.currentBasket.number,
        fullBasket: this.currentBasket.letter + this.currentBasket.number
      };

      if (basket.letter !== 'G' && basket.number[0]) {
        this.currentCart = basket.number[0];
      }

      this.currentBasket = basket;
      this.basketSelected = true;
    };
    ...
    shopping.prototype.moveShoppingForward = function moveShoppingForward() {
      ...
      var currentOutcome = this.currentPendGroup.getOutcome(this.shoppingIndex);
      this.formComplete = false;
      if (currentOutcome === 'missing' && this.shopList[this.shoppingIndex].saved !== 'missing') {
    ...
    shopping.prototype.advanceShopping = function advanceShopping() {
      ...
      console.log(this.currentPendGroup);
      this.currentPendGroup.saveShoppingResults(this.shoppingIndex, this.currentBasket, function () {

        if (_this10.shoppingIndex >= _this10.shopList.length - 1) {
          _this10.refreshPendedGroups();
          _this10.loadGroupSelectionPage();
          _this10.resetShopper();
        } else _this10.setShoppingIndex(_this10.shoppingIndex + 1);
      });
    };
    ...
    shopping.prototype.initShoppingIndexParameters = function initShoppingIndexParameters() {
      this.currentBasket = this.currentPendGroup.prepShoppingIndex(this.shoppingIndex);
      this.basketSelected = this.currentBasket !== null;
      ...
      this.formComplete = this.currentBasket !== null && this.shopList[this.shoppingIndex].outcomeText !== null && typeof this.shopList[this.shoppingIndex].outcomeText !== 'undefined';
    };
    ...
    shopping.prototype.setShoppingIndex = function setShoppingIndex(index) {
      ...
      var goToIndex = function goToIndex() {
        ...
        _this11.initShoppingIndexParameters();
    ...
    shopping.prototype.selectShoppingOption = function selectShoppingOption(key) {
      this.currentPendGroup.setOutcome(this.shoppingIndex, key);
      console.log(this.shoppingIndex, this.shopList[this.shoppingIndex].outcome);
      this.formComplete = true;
...
define('client/src/resources/v3/InventoryDate',['exports'], function (exports) {
    'use strict';
    ...
    var InventoryDate = exports.InventoryDate = function () {
        function InventoryDate() {
            var dateOrDateString = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : null;

            _classCallCheck(this, InventoryDate);

            if (dateOrDateString instanceof Date) {
                this.date = dateOrDateString;
            } else if (typeof dateOrDateString === 'string') {
                var dateParts = dateOrDateString.match(/(\d{4})-(\d{2})-(\d{2})[T\s](\d{2}):(\d{2}):(\d{2})/);

                console.log(dateParts);
                this.date = this.makeDate(dateParts[1], parseInt(dateParts[2], 10) - 1, dateParts[3]);
            } else this.date = new Date();
        }

        InventoryDate.prototype.makeDate = function makeDate(y, m, d) {
            var date = new Date();
        ...
        InventoryDate.prototype.addMonths = function addMonths(numMonths) {
            this.date.setMonth(this.date.getMonth() + numMonths);
            return this;
        };

        InventoryDate.prototype.components = function components() {
            return {
        ...
        InventoryDate.prototype.copyDate = function copyDate() {
            return this.makeDate.apply(this, Object.values(this.components()));
        };

        InventoryDate.prototype.copy = function copy() {};

        InventoryDate.prototype.willExpire = function willExpire() {
            var oneMonthFromToday = new InventoryDate().addMonths(1);
...
define('client/src/resources/v3/InventoryItem',["exports", "client/src/resources/helpers"], function (exports, _helpers) {
    "use strict";

    Object.defineProperty(exports, "__esModule", {
        value: true
    });
    exports.InventoryItem = undefined;
    ...
    var InventoryItem = exports.InventoryItem = function () {
        function InventoryItem(data) {
            ...
            for (var _iterator = Object.entries(data), _isArray = Array.isArray(_iterator), _i = 0, _iterator = _isArray ? _iterator : _iterator[Symbol.iterator]();;) {
                ...
                var propertyName = this.camelCase(datum[0]);
        ...
        InventoryItem.prototype.formatExpirationDate = function formatExpirationDate() {
            return this.expirationDate.substr(0, 10);
        };

        InventoryItem.prototype.calcWillExpire = function calcWillExpire() {
            var oneMonthFromNow = (0, _helpers.currentDate)(1);
            return oneMonthFromNow > this.expirationDate.slice(0, 7);
        };

        InventoryItem.prototype.calcIsRepack = function calcIsRepack() {
            return this.bin && this.bin.length === 3;
        };

        InventoryItem.prototype.camelCase = function camelCase(string) {
            return string.replace(/[_-]([a-z]|[0-9])/ig, function (all, letter) {
                return (letter + "").toUpperCase();
            });
        };

        InventoryItem.prototype.getValue = function getValue(propertyName) {
            if (this[propertyName]) {
                return this[propertyName];
            }

            var getterFunctionName = 'get' + propertyName;
...
define('client/src/resources/v3/InventoryItems',["exports"], function (exports) {
  "use strict";
  ...
  var InventoryItems = exports.InventoryItems = function InventoryItems() {
    _classCallCheck(this, InventoryItems);
  };
});
define('client/src/resources/v3/InventoryItemsList',["exports", "client/src/resources/helpers", "client/src/views/inventory", "client/src/resources/v3/InventoryItem", "client/src/resources/v3/InventoryDate"], function (exports, _helpers, _inventory, _InventoryItem, _InventoryDate) {
    "use strict";

    Object.defineProperty(exports, "__esModule", {
        value: true
    });
    exports.InventoryItemsList = undefined;
    ...
    var InventoryItemsList = exports.InventoryItemsList = function () {
        function InventoryItemsList() {
            _classCallCheck(this, InventoryItemsList);
        ...
        InventoryItemsList.prototype.setItems = function setItems(items) {
            this.inventoryItems = [];

            for (var _iterator = Object.keys(items), _isArray = Array.isArray(_iterator), _i = 0, _iterator = _isArray ? _iterator : _iterator[Symbol.iterator]();;) {
                var _ref;
                ...
                this.inventoryItems[itemIndex] = new _InventoryItem.InventoryItem(itemData);
            }

            this.isEmpty = this.inventoryItems.length === 0;

            for (var _iterator2 = Object.entries(this.inventoryItems), _isArray2 = Array.isArray(_iterator2), _i2 = 0, _iterator2 = _isArray2 ? _iterator2 : _iterator2[Symbol.iterator]();;) {
                var _ref2;
        ...
        InventoryItemsList.prototype.updateCounts = function updateCounts() {
            var blankCountsObj = {
                isChecked: false,
                count: 0,
                qty: 0
            ...
            for (var _iterator3 = this.inventoryItems, _isArray3 = Array.isArray(_iterator3), _i3 = 0, _iterator3 = _isArray3 ? _iterator3 : _iterator3[Symbol.iterator]();;) {
                var _ref3;
                ...
                var inventoryItem = new _InventoryItem.InventoryItem(item);

                for (var _iterator4 = Object.keys(inventoryCounts), _isArray4 = Array.isArray(_iterator4), _i4 = 0, _iterator4 = _isArray4 ? _iterator4 : _iterator4[Symbol.iterator]();;) {
                    var _ref4;
                    ...
                    var propertyName = _ref4;

                    var itemPropertyValue = inventoryItem[propertyName];
        ...
        InventoryItemsList.prototype.selectItemById = function selectItemById(id) {
            var inventoryItem = this.getItemById(id);
        ...
        InventoryItemsList.prototype.unselectItemById = function unselectItemById(id) {
            var inventoryItem = this.getItemById(id);
        ...
        InventoryItemsList.prototype.isItemIdSelected = function isItemIdSelected(id) {
            return this.selectedStatusById[id];
        };

        InventoryItemsList.prototype.toggleSelectedById = function toggleSelectedById(id) {
            if (this.isItemIdSelected(id)) {
        ...
        InventoryItemsList.prototype.getSelectedItemIds = function getSelectedItemIds() {
            return Object.keys(this.selectedItems);
        };

        InventoryItemsList.prototype.getSelectedMinExpirationDate = function getSelectedMinExpirationDate() {
            var expirationDate = null;

            for (var _iterator5 = Object.values(this.selectedItems), _isArray5 = Array.isArray(_iterator5), _i5 = 0, _iterator5 = _isArray5 ? _iterator5 : _iterator5[Symbol.iterator]();;) {
                var _ref5;
        ...
        InventoryItemsList.prototype.getSelectedItems = function getSelectedItems() {
            return this.selectedItems;
        };

        InventoryItemsList.prototype.initRepack = function initRepack() {
            var newItems = [];

            var defaultExpiration = this.getSelectedMinExpirationDate();

            var defaultRepackQty = 30 * Math.floor(this.selectedItemCounts.qty / 30);

            var selectedItemQuantity = this.getSelectedItemQuantity();

            var sourceItemIds = this.getSelectedItemIds();
        ...
        InventoryItemsList.prototype.getSelectedItemCount = function getSelectedItemCount() {
            return this.selectedItemCounts.count;
        };

        InventoryItemsList.prototype.getSelectedItemQuantity = function getSelectedItemQuantity() {
            return this.selectedItemCounts.qty;
        };

        InventoryItemsList.prototype.getItemIndexUsingId = function getItemIndexUsingId(id) {
            var index = null;
        ...
        InventoryItemsList.prototype.getItemById = function getItemById(id) {
            return this.inventoryItems[this.getItemIndexUsingId(id)];
        };

        InventoryItemsList.prototype.removeItemById = function removeItemById(id) {
            var index = this.getItemIndexUsingId(id);

            if (index !== null) {
                var inventoryItem = this.inventoryItems[index];
...
define('client/src/resources/v3/PendGroup',['exports'], function (exports) {
    'use strict';
    ...
    var PendGroup = exports.PendGroup = function () {
        PendGroup.prototype.isShoppable = function isShoppable() {
            return this.shopList && this.shopList.length > 0;
        };

        function PendGroup() {
            var serverData = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : null;

            _classCallCheck(this, PendGroup);
        ...
        PendGroup.prototype.importServerData = function importServerData(groupData) {
            this.baskets = groupData && groupData.baskets ? groupData.baskets.split(',') : [];
            this.isLockedByCurrentUser = groupData.is_locked === 1 && parseInt(groupData.locked_by, 10) === v3.currentUser.id;
        ...
        PendGroup.prototype.loadFromName = function loadFromName(name, callback) {
            var _this = this;

            var request = v3.getRequest('picking/load/' + name);

            request.onSuccess(function (serverData) {
                _this.importServerData(serverData);
        ...
        PendGroup.prototype.saveBasket = function saveBasket(basket) {
            var _this2 = this;

            var request = v3.postRequest('picking/save_basket', {
                groupName: this.name,
                basket: basket
            });

            request.onSuccess(function (allBaskets) {
                _this2.baskets = allBaskets;
            });

            return request;
        };

        PendGroup.prototype.onShopListLoad = function onShopListLoad(callback) {
            this.onShopListLoadCallback = callback;
        };

        PendGroup.prototype.runOnShopListLoadCallback = function runOnShopListLoadCallback() {
            if (this.onShopListLoadCallback) {
                this.onShopListLoadCallback();
            }
        };

        PendGroup.prototype.loadShopList = function loadShopList(callback) {
            var _this3 = this;

            var request = v3.getRequest('picking/shop_list/' + this.name);

            request.onSuccess(function (serverData) {
                _this3.importShopList(serverData);
        ...
        PendGroup.prototype.importShopList = function importShopList(serverData) {
            var _this4 = this;
            ...
            this.shopList.forEach(function (item, index) {
                if (item.picked_result) {
                    _this4.setOutcome(index, item.picked_result);
                }
            });
            this.indexItems();
        ...
        PendGroup.prototype.indexItems = function indexItems() {
            var _this5 = this;

            this.mapPendItemIdToIndex = {};
            this.pendItems.forEach(function (pendItem, index) {
                _this5.mapPendItemIdToIndex[pendItem.id] = index;
            });

            this.mapShopListItemIndexToPendItemIndex = {};
            this.shopList.forEach(function (shopListItem, index) {
                _this5.mapShopListItemIndexToPendItemIndex[index] = _this5.mapPendItemIdToIndex[shopListItem.pend_item_id];
            });
        };

        PendGroup.prototype.prepShoppingIndex = function prepShoppingIndex(index) {
            var pendItemStatus = this.getPendItemStatus(index);
            var baskets = pendItemStatus ? pendItemStatus.baskets : null;

            if (baskets && baskets.length) {
                var basket = baskets.slice(-1)[0];

                var letter = basket.slice(0, 1);
                var number = basket.slice(1);
        ...
        PendGroup.prototype.getPendItemStatus = function getPendItemStatus(shopListItemIndex) {
            var pendItemIndex = this.mapShopListItemIndexToPendItemIndex[shopListItemIndex];
            console.log(shopListItemIndex, pendItemIndex, this.pendItems);

            return this.pendItems[pendItemIndex];
        };

        PendGroup.prototype.saveShoppingResults = function saveShoppingResults(index, basket, callback) {
            var _this6 = this;

            var request = v3.postRequest('picking/pick_item', {
            ...
            request.onSuccess(function (serverData) {
                _this6.importShopList(serverData);
                if (callback) {
                    callback();
                }
            });
        ...
        PendGroup.prototype.setOutcome = function setOutcome(index, outcome) {
            var outcomeObject = {
                'exact_match': false,
                'roughly_equal': false,
                'slot_before': false,
        ...
        PendGroup.prototype.getOutcome = function getOutcome(index) {
...
define('client/../../client/src/resources/v3/app.js',['aurelia-http-client'], function (_aureliaHttpClient) {
    'use strict';
    ...
    var Request = function () {
        ...
        Request.prototype.serverUrl = function serverUrl(urlPart) {
            return 'http://localhost:7000/' + urlPart;
        };

        Request.prototype.get = function get(urlPart) {
            this.request = httpClient.get(this.serverUrl(urlPart));
            return this;
        };

        Request.prototype.post = function post(urlPart, data) {
            this.request = httpClient.post(this.serverUrl(urlPart), data);
            return this;
        };

        Request.prototype.handleServerResponse = function handleServerResponse(callback) {
            var _this = this;

            this.serverResponseHandler = callback;

            this.request.then(function (httpResponseMessage) {
                _this.serverResponse = httpResponseMessage;
                _this.handleResponse();
            });
        };

        Request.prototype.onError = function onError(callback) {
        ...
        Request.prototype.onSuccess = function onSuccess(callback) {
            this.handleServerResponse(callback);
            return this;
        };

        Request.prototype.onResponse = function onResponse(callback) {
            this.handleServerResponse(callback);
            return this;
        };

        Request.prototype.handleResponse = function handleResponse(response) {
        ...
        Request.prototype.runErrorHandler = function runErrorHandler() {
    ...
    var v3 = function () {
        ...
        v3.prototype.getRequest = function getRequest(urlPart) {
            return new Request().get(urlPart);
        };

        v3.prototype.postRequest = function postRequest(urlPart, data) {
            return new Request().post(urlPart, data);
        };

        v3.prototype.getCurrentUser = function getCurrentUser() {
            var _this2 = this;

            var gettingUser = function gettingUser(resolve, reject) {
                _this2.getRequest('current_user').onResponse(function (responseData) {
                    _this2.currentUser = responseData.body;
                    _this2.xsrfToken = responseData.data.token;

                    httpClient.configure(function (config) {
                        config.withHeader('X-XSRF-TOKEN', _this2.xsrfToken);
                    });
                    console.log(_this2);
                });

                resolve(_this2.curretnUser);
            };
...
define('client/src/resources/v3/picking',[], function () {
  "use strict";
});
define('client/src/resources/v3/request',["exports"], function (exports) {
  "use strict";
